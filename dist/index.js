...
function parsePortArg(defaultPort) {
...
function saveConfig(db, proxyPort, dryRun) {
    const config = {
        db,
...
async function checkDbConnection(connectionString) {
...
async function commandStart() {
    ...
    const { startProxy } = await Promise.resolve().then(() => __importStar(require('./proxy/start')));
