...
const lineage_1 = require("../proxy/lineage");
const chain_detector_1 = require("../proxy/chain-detector");
const lineage_2 = require("../proxy/lineage");
const DB_CONFIG = {
    host: 'localhost',
    port: 5432,
    database: 'testdb',
...
const server = new index_js_1.Server({ name: 'flowkernel', version: '0.1.0' }, { capabilities: { tools: {} } });
...
server.setRequestHandler(types_js_1.CallToolRequestSchema, async (request) => {
    ...
    if (name === 'query_database') {
        ...
        try {
            ...
            // Optimize
            const optimized = (0, optimizer_1.optimizeQuery)(sql, { users: 1000, orders: 5000 });
            // Chain detection
            const chain = (0, chain_detector_1.trackQuery)(MCP_SESSION_ID, sql);
    ...
    if (name === 'get_usage_stats') {
        ...
        const records = (0, lineage_2.readLineage)(lastN);
        const stats = {
